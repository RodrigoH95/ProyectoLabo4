        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UrlImg = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductoUsuario", x => new { x.UserId, x.ProductoId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductoUsuario_ProductoId",
